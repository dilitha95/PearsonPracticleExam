...
public class CountryController {
	...
	public ResponseEntity<Country> updateCountry(@PathVariable("id") String id, @RequestBody Country country) {
		Optional<Country> countryData = countryRepository.findById(id);
	...
	public ResponseEntity<HttpStatus> deleteCountry(@PathVariable("id") String id) {
		try {
